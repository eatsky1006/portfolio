...
const Projects = () => {
  ...
  const projects = useMemo(() => [
    ...
    {
      title: 'Near network',
      description: 'NEAR is a scalable, carbon-neutral blockchain platform that enables fast, low-cost transactions and empowers developers to build user-friendly decentralized applications and digital economies.',
      logo: nearlogo,
  ...
  return (
    <>
      <Helmet>
        <title>kk Borer - Full-Stack & Blockchain Developer</title>
        <meta name="description" content="Explore kk Borer's blockchain and web development projects including Popit Game, PerkSwap, and Cro Create - showcasing expertise in DeFi, smart contracts, and Web3 technologies." />
      </Helmet>
              ...
              >
                ...
                >
                  <Box
                    ...
                    loading='lazy'
                    src={project.logo}
                    alt={`${project.title} - Web3 Project by kk Borer`}
                    sx={{
                      width: 150,
                      maxWidth: '100%',
                      minWidth: 150,
